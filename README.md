...
- Forty-nine nearby 96 m chunks stream around the car, with a coarse terrain mesh extending the horizon beyond them. Trees and landmark construction use instanced geometry, distant objects are omitted, and discarded chunk resources are disposed. Bounded height and feature caches reuse terrain samples as the car crosses chunks.
